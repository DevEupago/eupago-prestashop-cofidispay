...
*/
class Eupago_cofidispayValidationModuleFrontController extends ModuleFrontController
{
    /**
    ...
    public function postProcess()
    {
        ...
        return $this->module->validateOrder($cart->id, $payment_status, $cart->getOrderTotal(), $module_name, $message, [], $currency_id, false, $secure_key);
    }
